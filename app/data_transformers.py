...
def prepare_features_ru(input_data: RuInput) -> RuFeatures:
    ...
    features: RuFeatures = {
        ...
        "МатериалСтен_бревно":  input_data.wall_material == WallMaterial.timber,
        "МатериалСтен_брус": input_data.wall_material == WallMaterial.bar,
        "МатериалСтен_газоблоки": input_data.wall_material == WallMaterial.gas_block,
        "МатериалСтен_железобетонные_панели": input_data.wall_material == WallMaterial.metall_panels,
        "МатериалСтен_кирпич": input_data.wall_material == WallMaterial.brick,
        "МатериалСтен_металл": input_data.wall_material == WallMaterial.metall,
        "МатериалСтен_пеноблоки": input_data.wall_material == WallMaterial.foam_block,
        "МатериалСтен_сэндвич_панели": input_data.wall_material == WallMaterial.sandwich_panels,
